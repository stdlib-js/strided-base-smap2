...
```javascript
import smap2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-smap2@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-smap2@v0.2.1-deno/mod.js';
```
