...
```javascript
import smap2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-smap2@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/strided-base-smap2/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/strided-base-smap2/actions/workflows/test.yml?query=branch:v0.2.2
